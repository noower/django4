...
#개발 과정에서의 기본 도메인 주소는 : 127.0.0.1:8000/
'''
...
urlpatterns = [
    ...
    path('', main),
    #http://127.0.0.1:8000/booklist 입력시, booklist 뷰함수가 호출됨
    ...
    #customlogin폴더에 있는 urls.py
    path('login/', include('customlogin.urls')),
    #social_django폴더 안에 있는 urls.py
...
#127.0.0.1:8000/files/ 로 시작하는 요청은 프로젝트폴터/files/에서 파일을 꺼내도록 URL등록
